            ...
            <div id="content">
                <div class="row">
                    <div class="large-3 columns">
                        <h2>Menu</h2>
                        <ul class="side-nav">
                            <li><?= $this->Html->link('Applications', array('controller' => 'applications', 'action' => 'index', 'admin' => true)) ?></li>
                            <li><?= $this->Html->link('Users', array('controller' => 'users', 'action' => 'index', 'admin' => true)) ?></li>
                        </ul>
                    </div>
